...
#define CACHEFLUSH(addr, size) __builtin___clear_cache(addr, addr + size);VALGRIND_CACHE_FLUSH(addr, size)
    ...
    #define CODESIZE 68U
    #define CODESIZE_MIN 68U
    #define CODESIZE_MAX CODESIZE
    #define REPLACE_FAR(t, fn, fn_stub)\
        ((uint32_t *)fn)[0] = 0x27bdffc0;\
        ((uint32_t *)fn)[1] = 0xafbf003c;\
        ((uint32_t *)fn)[2] = 0xafbe0038;\
        ((uint32_t *)fn)[3] = 0xafb00034;\
        ((uint32_t *)fn)[4] = 0x03a0f025;\
        *(uint16_t *)(fn + 20) = (long long)fn_stub >> 16;\
        *(fn + 22) = 0x19;\
        *(fn + 23) = 0x3c;\
        *(uint16_t *)(fn + 24) = (long long)fn_stub;\
        *(fn + 26) = 0x39;\
        *(fn + 27) = 0x37;\
        ((uint32_t *)fn)[7] = 0x0320f809;\
        ((uint32_t *)fn)[8] = 0x00000000;\
        ((uint32_t *)fn)[9] = 0x00000000;\
        ((uint32_t *)fn)[10] = 0x03c0e825;\
        ((uint32_t *)fn)[11] = 0x8fbf003c;\
        ((uint32_t *)fn)[12] = 0x8fbe0038;\
        ((uint32_t *)fn)[13] = 0x8fb00034;\
        ((uint32_t *)fn)[14] = 0x27bd0040;\
        ((uint32_t *)fn)[15] = 0x03e00008;\
        ((uint32_t *)fn)[16] = 0x00000000;\
        CACHEFLUSH((char *)fn, CODESIZE);
    #define REPLACE_NEAR(t, fn, fn_stub) REPLACE_FAR(t, fn, fn_stub)
